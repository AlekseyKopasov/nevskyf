...
var _submitForm = require("./modules/submit-form");
var _dateMask = require("./modules/date-mask");
var _toggleSections = require("./modules/toggle-sections");
var _inputOwnVersion = require("./modules/input-own-version.js");
var _singleCheckbox = require("./modules/single-checkbox");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _submitForm.submitForm)();
    (0, _dateMask.addDateMask)();
    (0, _toggleSections.toggleSections)();
    (0, _inputOwnVersion.inputOwnVersion)();
    (0, _singleCheckbox.singleCheckbox)();
...
},{"./modules/date-mask":2,"./modules/form-validate/form":4,"./modules/input-own-version.js":10,"./modules/modals/init-modals":11,"./modules/select/custom-select":14,"./modules/single-checkbox":15,"./modules/submit-form":16,"./modules/toggle-sections":17,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
function addDateMask() {
  var dates = document.querySelectorAll('input[data-date="date"]');

  /* eslint-disable */
  if (dates) {
    dates.forEach(function (date) {
      var patternMask = IMask(date, {
        /* eslint-enable */
        mask: '{00}.{00}.{0000}'
      });
    });
...
var Validator = /*#__PURE__*/function () {
  ...
  _createClass(Validator, [{
    ...
    key: "_validateNumberInput",
    value: function _validateNumberInput(parent, input) {
      var flag = true;
    ...
    value: function _validateToggleGroup(parent) {
      ...
      var title = parent.querySelector('.register__error-text');
      var flag = true;
      if (this._returnCheckedElements(formElements)) {
        formElements.forEach(function (input) {
          _this2._setItemInvalidState(input.parentElement.parentElement, input);
          title.textContent = 'Выберите дату';
          _this2._removeGroupAria(formElements);
          flag = false;
        });
      } else {
        formElements.forEach(function (input) {
          _this2._setItemValidState(input.parentElement.parentElement, input);
          title.textContent = '';
          _this2._setGroupAria(formElements);
          flag = true;
        });
      }
      return flag;
    ...
    value: function validateFormElement(formElement) {
      ...
      var isValid = true;
      var isHidden = parent.classList.contains('is-hidden') || parent.parentElement.classList.contains('is-hidden');
      if (!isHidden) {
    ...
    value: function _fullValidate(items) {
      ...
      items.forEach(function (item) {
        ...
        _this3.validateFormElement(formElement, true);
...
exports.inputOwnVersion = void 0;
var inputOwnVersion = function inputOwnVersion() {
  var person = document.querySelector('[data-select="person"]');
  var HIDDEN_CLASS = 'is-hidden';
  if (!person) {
    return;
  }
  var clickHandler = function clickHandler() {
    var text = person.querySelector('.custom-select__text');
    var input = document.querySelector('[data-input="person"]');
    var inputField = input.querySelector('input');
    var ownText = 'Другое (указать)';
...
exports.inputOwnVersion = inputOwnVersion;
...
},{"../../utils/focus-lock":18,"../../utils/scroll-lock":22}],13:[function(require,module,exports){
"use strict";
...
var createNativeSelectMarkup = function createNativeSelectMarkup(_ref) {
  ...
  return "<select ".concat(id ? "id='".concat(id, "'") : '', " ").concat(name ? "name='".concat(name, "'") : '', " ").concat(multiple ? 'multiple' : '', " ").concat(required ? 'required' : '', " tabindex=\"-1\" aria-hidden=\"false\">\n            <option value=\"\"></option>\n            ").concat(createNativeOptionsMarkup(items, activeIndex), "\n          </select>");
};
...
},{"../../utils/render":21,"./create-select-markup":13}],15:[function(require,module,exports){
"use strict";
...
var singleCheckbox = function singleCheckbox() {
  var checkboxes = document.querySelectorAll('.custom-toggle--single');
  ...
  var toggleCheckboxes = function toggleCheckboxes(inputs, target) {
    inputs.forEach(function (input) {
  ...
  var clickHandler = function clickHandler(evt) {
    var target = evt.target;
    var inputs = target.parentElement.parentElement.parentElement.querySelectorAll('input');
...
var submitForm = function submitForm() {
  ...
  var successModal = document.querySelector('.modal.js-success');
  var errorModal = document.querySelector('.modal.js-error-modal');
  var NEVSKY_FORUM_PAGE = 'https://science.spb.ranepa.ru/nevskyforum';
  var URL = 'form-mailer.php';
  var errorsMsgSet = {
  ...
  var showSuccesModal = function showSuccesModal() {
    if (!successModal) {
      return;
    }
    modals.open('success');
  ...
  var showErrorModal = function showErrorModal() {
    var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : errorsMsgSet.default;
    if (!errorModal) {
      return;
    }
    var description = errorModal.querySelector('.modal__description');
  ...
  var submitHandler = function submitHandler(evt) {
    ...
    var fetchData = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
        var formData, _iterator, _step, d;
    ...
    setTimeout(function () {
      if (window.form._validState) {
        ...
        var selects = form.querySelectorAll('.custom-select__list');
        var formData = new FormData();
        inputs.forEach(function (input) {
          var name = input.getAttribute('name');
          var checkbox = input.getAttribute('type') === 'checkbox';
          var isHiddenCheckboxParent = input.parentElement.parentElement.parentElement.parentElement.classList.contains('is-hidden');
        ...
        selects.forEach(function (select) {
          var item = select.querySelector('.custom-select__item[aria-selected="true"]');
          var name = select.parentElement.querySelector('select').getAttribute('name');
...
exports.toggleSections = void 0;
var toggleSections = function toggleSections() {
  var dateTabs = document.querySelector('.register__fieldset[data-tabs="sections-tabs"]');
  if (!dateTabs) {
    return;
  }
  var HIDDEN_CLASS = 'is-hidden';
  var inputHandler = function inputHandler(evt) {
    ...
    var panels = dateTabs.parentElement.querySelectorAll("[data-sections-tab=\"".concat(id, "\"]"));
    if (!panels) {
      return;
    }
  ...
  var clickHandler = function clickHandler() {
    var title = document.querySelector('[data-sections="panel"] .register__title');
    if (!title) {
      return;
    }
    setTimeout(function () {
      var allEmptyCheckboxes = dateTabs.querySelector('.custom-toggle--checkbox.is-valid');
