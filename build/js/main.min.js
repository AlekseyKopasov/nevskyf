...
},{"./modules/date-mask":2,"./modules/form-validate/form":4,"./modules/input-own-version.js":10,"./modules/modals/init-modals":11,"./modules/select/custom-select":14,"./modules/submit-form":15,"./modules/toggle-sections":16,"./utils/ios-vh-fix":19}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/render":20,"./create-select-markup":13}],15:[function(require,module,exports){
"use strict";
    ...
    setTimeout(function () {
      if (window.form._validState) {
        ...
        fetch('form-mailer.php', {
          ...
          body: JSON.stringify.apply(JSON, _toConsumableArray(formData))
        }).then(function (res) {
          if (res.status === '200') {
